...
[Project page](https://robot9706.github.io/MusicLightController/)

# Description
Used for a project where I recycled an old LED light to make some music controlled LEDs. The LEDs are controlled using a ATmega328P-PU (Ardunio UNO CPU) on a standalone PCB with 2 60V/50A (way overkill) MOSFETs, the LEDs run on 24V and they require 100mA max. The brightness is controlled by PWM (PWM pin 5 and 6).
